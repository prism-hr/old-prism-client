...
/** @ngInject */
export const materialConfig = function ($mdThemingProvider: any, $mdDateLocaleProvider: any, $provide: any) {
    ...
    $provide.decorator('mdDatepickerDirective', $delegate => {
        ...
        mdDatepicker.compile = function () {
            return function fixMdDatepickerLink(scope: any, element: any, attr: any, controllers: any) {
